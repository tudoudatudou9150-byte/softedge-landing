...
create table if not exists public.orders (
  ...
  style text not null check (style in ('L-Shaped', 'T-Shaped', 'Round', 'Icy Cooling Loop Fan - White', 'Icy Cooling Loop Fan - Black', 'Under-Sink Pull-Out Organizer - White', 'Under-Sink Pull-Out Organizer - Black')),
  pack_size integer not null check (pack_size in (1, 4, 8, 16, 20, 29, 33, 39, 41, 48)),
